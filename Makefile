...
$(BIN_DIR)/game: $(OBJ_DIR)/Game.o $(OBJ_DIR)/Board.o $(OBJ_DIR)/Engine.o $(OBJ_DIR)/MoveCalculator.o $(OBJ_DIR)/CommandLineParser.o $(OBJ_DIR)/Utils.o
	$(CXX) $(CFLAGS) -o $(BIN_DIR)/game $(OBJ_DIR)/Game.o $(OBJ_DIR)/Board.o $(OBJ_DIR)/Engine.o $(OBJ_DIR)/MoveCalculator.o $(OBJ_DIR)/CommandLineParser.o $(OBJ_DIR)/Utils.o

$(OBJ_DIR)/PGNCreator.o: PGNCreator.cc PGNCreator.h Board.h MoveCalculator.h
	$(CXX) $(CFLAGS) -c -o $(OBJ_DIR)/PGNCreator.o PGNCreator.cc

$(OBJ_DIR)/PGNCreator_t.o: PGNCreator_t.cc PGNCreator.h MoveCalculator.h Board.h utils/Test.h utils/Mock.h utils/Utils.h
	$(CXX) $(CFLAGS) -c -o $(OBJ_DIR)/PGNCreator_t.o PGNCreator_t.cc

$(OBJ_DIR)/Game.o: Game.cc Board.h Engine.h MoveCalculator.h
...
$(OBJ_DIR)/Engine.o: Engine.cc Engine.h MoveCalculator.h Board.h
	$(CXX) $(CFLAGS) -c -o $(OBJ_DIR)/Engine.o Engine.cc

$(OBJ_DIR)/Engine_t.o: Engine_t.cc Engine.h MoveCalculator.h Board.h utils/Test.h utils/Mock.h utils/Utils.h
